...
const TRANSLATIONS = {
  pl: {
    ...
    'summary.returns.sub': 'Od początku inwestycji i korelacja z rynkiem',
    'summary.returns.twr': 'TWR',
    'summary.returns.mwr': 'MWR',
    'summary.returns.annualized': 'Stopa zwrotu (roczna)',
    'summary.returns.annualized.sub': 'TWR i MWR w skali roku',
  ...
  en: {
    ...
    'summary.returns.sub': 'Since inception and correlation with the market',
    'summary.returns.twr': 'TWR',
    'summary.returns.mwr': 'MWR',
    'summary.returns.annualized': 'Rate of return (annualized)',
    'summary.returns.annualized.sub': 'Annualized TWR and MWR',
